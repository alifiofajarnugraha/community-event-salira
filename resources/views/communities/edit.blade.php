    ...
    <form action="{{ route('communities.update', $community) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow p-6 md:p-8 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
                ...
                <input type="text" name="icon" value="{{ old('icon', $community->icon) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="spark, code, leaf, etc.">
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="accent" value="{{ old('accent', $community->accent) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="#E6F2FF">
        ...
        <div class="space-y-1">
            ...
            <input type="text" name="tags_input" value="{{ old('tags_input', is_array($community->tags) ? implode(', ', $community->tags) : '') }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="#Tag1, #Tag2, #Tag3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="space-y-1">
                ...
                <input type="text" name="members" value="{{ old('members', $community->members) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="21k">
            ...
            <div class="space-y-1">
                ...
                <input type="number" name="posts_today" value="{{ old('posts_today', $community->posts_today) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
            ...
            <div class="space-y-1">
                ...
                <input type="number" name="member_count" value="{{ old('member_count', $community->member_count) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
                ...
                <input type="text" name="subtitle" value="{{ old('subtitle', $community->subtitle) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="event_tag" value="{{ old('event_tag', $community->event_tag) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
        ...
        <div class="space-y-1">
            ...
            <input type="url" name="cover" value="{{ old('cover', $community->cover) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
                ...
                <input type="text" name="location" value="{{ old('location', $community->location) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
                @error('location')<p class="text-sm text-red-600 mt-1">{{ $message }}</p>@enderror
            </div>
            <div class="space-y-1">
                <label class="block text-sm font-medium text-gray-700">Date</label>
                <input type="text" name="date" value="{{ old('date', $community->date) }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
        ...
        <div class="space-y-1">
            ...
            <textarea name="long_description" rows="4" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">{{ old('long_description', $community->long_description) }}</textarea>
        ...
        <div class="space-y-1">
            ...
            <input type="text" name="rules_input" value="{{ old('rules_input', is_array($community->rules) ? implode(', ', $community->rules) : '') }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="Rule1, Rule2, Rule3">
        ...
        <div class="space-y-1">
            <label class="flex items-center">
                <input type="checkbox" name="is_joined" value="1" {{ old('is_joined', $community->is_joined) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:border-blue-500 focus:ring-blue-500">
